...
public class ConnectorDs extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        if(clickedButton.getId()==R.id.submit_btn){
            ...
            else if(selectedAnswer.equals(QuestionAnswer.correctAnswers[currentQuestionIndex])){
                score++;
                selectedAnswer="";
                currentQuestionIndex++;
                loadNewQuestion();
